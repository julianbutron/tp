...
<!-- diseño de cabecera con buscador-->	
	<form ACTION="buscar_supervisor.php" METHOD="POST">
	<div class="buscar">
...
<?php
	...
	$cadena ="SELECT * FROM empleado WHERE id_cargo= 3";
...
?>
 ...
 <a href= "generar_pdf_supervisor.php"><input type="submit" value="Exportar PDF" class="boton_pdf"></a>
