<html>
<head>
<title> Eliminar Chofer2 </title>
<!-- Utilizo mismo estilo eliminar empleado 2 -->
...
$consulta= mysql_query("SELECT id FROM cliente WHERE id = '$_POST[id]'", $conexion);
...
if($consulta2 = mysql_fetch_array($consulta))
	{
	mysql_query("DELETE FROM cliente WHERE id = '$_POST[id]'" , $conexion);
...
?>
	<div class="sesion">
	<a href="ABM_cliente.php"><input type="submit" value="Volver" class="boton_volver"></a>
	</div>
	</div>
</div>
</body>
