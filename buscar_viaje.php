...
<p><b><a href="seguimiento.php?id= <?.$row['cod'];?>"><?=
	  "<table bgcolor='#BDC5F2' cellpadding='0' align='center' cellspacing='0' width='100%'>
	  <tr> 
	  <td width='37' align='center'>".$row['cod']."</td>   
      <td width='80'>".$row['fecha_partida']."</td>
	  <td width='84'>".$row['fecha_llegada']."</td>
	  <td width='65'>".$row['id_cliente']."</td>
	  <td width='60'>".$row['tipo_carga']."</td> 
	  <td width='200'>".$row['domicilio_o'].", ".$row['ciudad_o'].", ".$row['provincia_o'].", ".$row['pais_o']."</td> 
	  <td width='235'>".$row['domicilio_d'].", ".$row['ciudad_d'].", ".$row['provincia_d'].", ".$row['pais_d']."</td> 
	  <td width='80'>".$row['id_vehiculo']."</td>
	  <td width='50'>".$row['id_chofer']."</td>
	  <td width='40'>".$row['combustible']."</td>
	  <td width='40'>".$row['km']."</td>
	  <td width='30'>".$row['horas']."</td>
      </tr>
	  </table>";?></a></b></p>
<?php
