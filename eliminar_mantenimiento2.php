<html>
<head>
<title> Eliminar Mantenimiento 2 </title>
...
$consulta= mysql_query("SELECT cod FROM mantenimiento WHERE cod = '$_POST[cod]'", $conexion);
...
if($consulta2= mysql_fetch_array($consulta)){
	mysql_query("DELETE FROM mantenimiento WHERE cod = '$_POST[cod]'" , $conexion);	
...
?>
	<div class="sesion">
	<a href="ABM_mantenimiento.php"><input type="submit" value="Volver" class="boton_volver"></a>
	</div>
	</div>
</div>
</body>
