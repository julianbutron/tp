<html>
<head>
<title> Consultar viaje 2 </title>
<link rel="stylesheet" type="text/css" href="estilos\ver_lista_viajes.css">
</head>
<body Background="imagenes\fondo.jpg">
<div id="contenedor">
	<div id="cabecera">
<a href="menu_usuario.php"><img src="imagenes\cerrar.png" class="imagen_atras_buscar"/></a>
...
if(empty($buscar))
{
echo "<font color='red'> NO SE HA INGRESADO NUMERO DE DNI </font><br><br>";
}else{
...
$sql = "SELECT * 
		...
		WHERE EXISTS (SELECT 1
						FROM empleado E 
						WHERE E.id_cargo = 1
						AND   E.dni LIKE '$buscar%' ORDER BY cod ASC)";
...
echo "Resultados encontrados con DNI: <font color='red'><b>$buscar</b></font>";
...
<p><b><a href="consultar_viaje1.php?id= <?.$row['cod'];?>"><?=
